...
<div class="container marketing">
	...
	<div class="row">
		<div class="col-lg-4">
			<img class="img-circle" src="${ctx}/static/img/p1.jpg" alt="Generic placeholder image" style="width: 140px; height: 140px;">
			<h2>智能高清监控机器人</h2>
			<p>可爱的造型，摄像安防远程互联的全能设计，让你随时随地守护您的家人，陪伴你的生活。</p>
			<p><a class="btn btn-default" href="project.html" role="button">项目详情 &raquo;</a></p>
		</div><!-- /.col-lg-4 -->
		<div class="col-lg-4">
			<img class="img-circle" src="${ctx}/static/img/p2.jpg" alt="Generic placeholder image" style="width: 140px; height: 140px;">
			<h2>NEOKA智能手环</h2>
			<p>要运动更要安全，这款、名为“蝶舞”的NEOKA-V9100智能运动手环为“安全运动而生”。</p>
			<p><a class="btn btn-default" href="project.html" role="button">项目详情 &raquo;</a></p>
		</div><!-- /.col-lg-4 -->
		<div class="col-lg-4">
			<img class="img-circle" src="${ctx}/static/img/p3.png" alt="Generic placeholder image" style="width: 140px; height: 140px;">
			<h2>驱蚊扣</h2>
				...
				<div class="box ui-draggable" id="mainBox">
					...
					<div class="mBd" style="padding-top:10px;">
						<div class="row">
							<div class="col-md-3">
								<div class="thumbnail">
									<img alt="300x200" src="${ctx}/static/img/product-1.jpg" />
									<div class="caption">
										<h3 class="break">
							...
							<div class="col-md-3">
								<div class="thumbnail">
									<img alt="300x200" src="${ctx}/static/img/product-2.gif" />
									<div class="caption">
										<h3 class="break">
							...
							<div class="col-md-3">
								<div class="thumbnail">
									<img alt="300x200" src="${ctx}/static/img/product-4.jpg" />
									<div class="caption">
										<h3 class="break">
				...
				<div class="box ui-draggable" id="mainBox">
					...
					<div class="mBd" style="padding-top:10px;">
						<div class="row">
							<div class="col-md-3">
								<div class="thumbnail">
									<img alt="300x200" src="${ctx}/static/img/product-5.jpg" />
									<div class="caption">
										<h3 class="break">
											<a href="project.html">活性富氢净水直饮机</a>
										</h3>
							...
							<div class="col-md-3">
								<div class="thumbnail">
									<img alt="300x200" src="${ctx}/static/img/product-6.jpg" />
									<div class="caption">
										<h3 class="break">
											<a href="project.html">酷驰触控龙头，智享厨房黑科技</a>
										</h3>
							...
							<div class="col-md-3">
								<div class="thumbnail">
									<img alt="300x200" src="${ctx}/static/img/product-7.jpg" />
									<div class="caption">
										<h3 class="break">
											<a href="project.html">小熊猫鱼眼全景安防摄像机</a>
										</h3>
							...
							<div class="col-md-3">
								<div class="thumbnail">
									<img alt="300x200" src="${ctx}/static/img/product-8.jpg" />
									<div class="caption">
										<h3 class="break">
											<a href="project.html">一款精致的机械表</a>
										</h3>
				...
				<div class="box ui-draggable" id="mainBox">
					...
					<div class="mBd" style="padding-top:10px;">
						<div class="row">
							<div class="col-md-3">
								<div class="thumbnail">
									<img alt="300x200" src="${ctx}/static/img/product-9.jpg" />
									<div class="caption">
										<h3 class="break">
											<a href="project.html">活性富氢净水直饮机</a>
										</h3>
