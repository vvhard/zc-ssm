...
public class TReturn {
    ...
    public TReturn(Integer id, Integer projectid, String type, Integer supportmoney, String content, Integer count, Integer signalpurchase, Integer purchase, Integer freight, String invoice, Integer rtndate) {
        this.id = id;
